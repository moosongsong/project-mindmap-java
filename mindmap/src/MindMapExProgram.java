...
public class MindMapExProgram extends JFrame{
    ...
    public static int getLabelSize() {return labelSize;}
    public void setLabelSize(int labelSize) {this.labelSize = labelSize;}
    public static int getSizeMiniX2() {return sizeMiniX2;}
    public static void setSizeMiniX2(int sizeMiniX2) {MindMapExProgram.sizeMiniX2 = sizeMiniX2;}
    public static int getSizeY() {return sizeY;}
    public static void setSizeY(int sizeY) {MindMapExProgram.sizeY = sizeY;}
    public static int getSizeMiniX1() {return sizeMiniX1;}
...
class MyTree {
    ...
    public void setNext(MyTree obj) { next = obj; }
    public void setNextGrade(MyTree obj) {setNextgrade(obj);}
    public void setParent(MyTree obj) { parent = obj;}

    public MyTree getNext() {return next;}
    public MyTree getNextGrade() {return getNextgrade();}
    public MyTree getParent() {return parent;}
...
class AttributePane extends JPanel {
    ...
    AttributePane() {
        ...
        center.add(text); center.add(text_value); center.add(x); center.add(x_value);
        center.add(y); center.add(y_value); center.add(w); center.add(w_value);
        center.add(h); center.add(h_value); center.add(color); center.add(color_value);
